...
def on_chat_start():
    ...
    agent = project_client.agents.create_agent(
        ...
        instructions="""
            ...
            - azure ai search tool - fetches product information such as travel insurance, luggage, bags, wifi plan, accessories and other products based on user queries.
            When asked about products, you will not search the internet. You will only use the tools provided to you.
        """, 
        toolset=toolset
    )
